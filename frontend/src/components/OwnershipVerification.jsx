...
export default function OwnershipVerification({
  ...
  const verificationFields = {
    Électronique: [
      {
        id: "brand",
        label: "Quelle est la marque exacte ?",
        type: "text",
        weight: 15,
      },
      {
        id: "model",
        label: "Quel est le modèle exact ?",
        type: "text",
        weight: 15,
      },
      {
      ...
      {
        id: "screenCondition",
        label: "Quel est l'état de l'écran ?",
        type: "select",
        options: ["Intact", "Fissures légères", "Très fissuré"],
        weight: 10,
      },
      {
        id: "caseColor",
        label: "De quelle couleur est la coque ?",
        type: "text",
        weight: 10,
      },
      {
        id: "wallpaper",
        label: "Décrivez le fond d'écran",
        type: "textarea",
        weight: 20,
      },
      {
        id: "uniqueMarks",
        label: "Y a-t-il des autocollants ou marques distinctives ?",
        type: "textarea",
        weight: 20,
      },
    ],
    Bagagerie: [
      {
        ...
        label: "Type de sac",
        type: "select",
        options: ["Sac à dos", "Sac à main", "Valise", "Sacoche"],
        weight: 15,
      },
      ...
      { id: "color", label: "Couleur principale", type: "text", weight: 10 },
      {
        ...
        label: "Matière",
        type: "select",
        options: ["Cuir", "Tissu", "Synthétique", "Autre"],
        weight: 10,
      },
      { id: "pockets", label: "Nombre de poches", type: "number", weight: 10 },
      {
        id: "contents",
        label: "Contenu du sac (liste privée)",
        type: "textarea",
        weight: 20,
        private: true,
      },
      {
        id: "defects",
        label: "Défauts visibles (déchirures, taches)",
        type: "textarea",
        weight: 15,
      },
    ],
    Clés: [
      {
        ...
        label: "Type de clés",
        type: "select",
        options: ["Maison", "Voiture", "Bureau", "Cadenas"],
        weight: 15,
      },
      {
        id: "keyCount",
        label: "Nombre de clés sur le trousseau",
        type: "number",
        weight: 10,
      },
      {
        id: "keychain",
        label: "Description du porte-clés",
        type: "textarea",
        weight: 15,
      },
      {
        id: "carBrand",
        label: "Marque de voiture (si applicable)",
        type: "text",
        weight: 10,
      },
      {
        id: "attachedCards",
        label: "Cartes ou badges attachés",
        type: "textarea",
        weight: 10,
      },
      {
    ...
    Accessoires: [
      ...
      {
        id: "defects",
        label: "Défauts ou marques uniques",
        type: "textarea",
        weight: 20,
      },
    ],
  ...
  const calculateScore = () => {
    ...
    currentFields.forEach((field) => {
      ...
      console.log(
        `  ✅ Similarité: ${Math.round(
          similarity
        )}% - Score obtenu: ${fieldScore}/${field.weight}`
      );
    });
...
const handlePaymentSuccess = async (transaction) => {
  try {
    ...
    // Le paiement est déjà enregistré et l'accès accordé par le service
    // On peut juste fermer et notifier le parent
      ...
      <div className="p-6">
        <AnimatePresence mode="wait">
            ...
            >
              <div className="glass rounded-2xl p-8 text-center border border-border">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Avant d'accéder aux détails complets, nous devons vérifier que
                  vous êtes bien le propriétaire de cet objet.
                </p>
                ...
                <div className="bg-accent/10 border border-accent rounded-xl p-6 text-left mb-6">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Répondez aux questions de vérification sur l'objet
                        trouvé
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Vos réponses seront comparées sémantiquement avec celles
                        du trouveur
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Un score de correspondance sera calculé (casse et
                        accents ignorés)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Le paiement sera autorisé uniquement si le score dépasse
                        80%
                      </span>
                    </li>
                  </ul>
              ...
              <div className="glass rounded-2xl p-6 border border-border">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Répondez avec le maximum de précision
                      (majuscules/minuscules non prises en compte)
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 flex gap-4">
                  ...
                  <button
                    ...
                    disabled={
                      isProcessing ||
                      Object.keys(answers).length < currentFields.length
                    }
          ...
          {step === "result" && (
            ...
            >
              <div
                className={`glass rounded-2xl p-8 text-center border-2 ${
                ...
                {verificationScore >= 80 ? (
                  <>
                    <p className="text-lg text-muted-foreground mb-8">
                      Vos réponses correspondent bien aux informations du
                      trouveur. Vous pouvez maintenant procéder au paiement pour
                      accéder aux détails complets et contacter le trouveur.
                    </p>
                  ...
                  <>
                    <p className="text-lg text-muted-foreground mb-8">
                      Vos réponses ne correspondent pas suffisamment. Score
                      minimum requis: 80%
                    </p>
                    ...
                    <div className="bg-destructive/10 border border-destructive rounded-xl p-6 mb-8">
                      ...
                      <ul className="text-sm text-muted-foreground text-left space-y-2">
                        ...
                        <li>
                          • Si vous êtes sûr, contactez le support avec des
            ...
            >
              <div className="glass rounded-2xl p-8 border border-border">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <CreditCard size={20} />
                    Payer {accessFee} FCFA
                  </button>

                  <button
                    onClick={onClose}
                    className="w-full px-6 py-3 glass rounded-xl hover:bg-muted transition-colors"
                  >
                    Annuler
                  </button>
                </div>
                ...
                <PaymentModal
                  ...
                  amount={accessFee}
                  description={`Déblocage accès - ${item.title}`}
                  customerInfo={{
                    email: user?.email || "",
                    name:
