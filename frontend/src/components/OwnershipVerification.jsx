...
export default function OwnershipVerification({
  ...
  const verificationFields = {
    Électronique: [
      ...
      {
        id: "uniqueMarks",
        label: "Y a-t-il des autocollants ou marques distinctives ? Lesquels ?",
        type: "textarea",
        weight: 20,
      },
    ],
              ...
              <div className="bg-accent/10 border border-accent rounded-xl p-6 text-left mb-6">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Répondez aux questions de vérification sur l'objet trouvé
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-accent font-bold">2.</span>
                    <span>
                      Vos réponses seront comparées avec celles du trouveur
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Répondez avec le maximum de précision pour prouver votre
                    propriété
                  </p>
                </div>
              </div>
