...
export const sponsorService = {
  ...
  generateReferralUrl(sponsorCode) {
    ...
    const baseUrl = "https://obli-new-taupe.vercel.app/";
  ...
  generateQRCodeUrl(sponsorCode) {
    ...
    return `https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(referralUrl)}`;
  },
